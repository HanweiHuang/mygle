...
function av_enqueue_scripts() {
    ...
    //js
    wp_enqueue_script( 'jquery', $template_uri.'/lib/jquery/js/jquery-3.1.1.min.js', array(), false, true);
    wp_enqueue_script( 'bootstrap', $template_uri.'/lib/bootstrap-3.3.7/js/bootstrap.min.js', array(), false, true);
    ...
    $file = $basename.'.js';
    if(file_exists(get_template_directory().$file)) wp_enqueue_script( 'page-custom-js', $template_uri.$basename."=$av_site_version=.js", array(), false, true);
}
